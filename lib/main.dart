...
class MyApp extends StatelessWidget {
  ...
  const MyApp({Key key, this.left, this.top, this.right, this.bottom, this.width, this.height, this.child, this.onTapOutside})
      : super(key: key);
  @override
...
//                  child: new SimpleDialog();
                  ...
                  child: new SimpleDialog(
                      title: new Text('ttttt'),
                      titlePadding: const EdgeInsets.fromLTRB(50.0, 0.0, 0.0, 0.0),
                      contentPadding:const EdgeInsets.fromLTRB(5.0, 5.0, 5.0, 5.0),
                      children: [new Text('children'),
                      _buildImg('bg2.jpg'),
                      new Semantics(namesRoute: true, child: new Text('xxxx')),
                      ]
//                      content: new Text('okok'),
//                      actions: <Widget>[
//                        new FlatButton(
//                            onPressed: () {
